class Duck{
    ...
    moveToInitialPosition(){
        // Anchor duck to the grass top and lower slightly so it appears standing on the grass.
        // Uses the CSS variables defined in styles.css so it scales with #gameWrap.
